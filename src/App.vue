...
<template>
  <div class="fixed top-6 w-full px-4 sm:px-8 md:px-12 ">
    <nav class="z-50 max-w-5xl mx-auto rounded-full border border-slate-200/80 bg-white/80 backdrop-blur-xl shadow-lg">
      <div class="flex items-center justify-between px-7 py-4">
        <a href="#hero" class="text-lg font-bold tracking-wide text-slate-900">
